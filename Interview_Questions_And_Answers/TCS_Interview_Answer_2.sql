...
from school_of_it_2025.visiting v1 where not exists 
(
	select 1 from school_of_it_2025.visiting v2 
	where v1.visitor_id = v2.visitor_id and v2.visiting_place ='Goa'
)
